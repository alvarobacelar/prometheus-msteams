...
import (
	...
	"github.com/alvarobacelar/prometheus-msteams/pkg/service"
	"github.com/alvarobacelar/prometheus-msteams/pkg/transport"
	"github.com/alvarobacelar/prometheus-msteams/pkg/version"
...
func main() { //nolint: funlen
	var (
		...
		clientID                      = fs.String("client-id", "teste", "The value of client id of request sts")
		clientSecret                  = fs.String("client-secret", "teste1", "The value of client secret of request sts")
		urlSTSToken                   = fs.String("url-sts-token", "teste3", "The URL of request token")
	)
	...
	{
		service.NewSTSRequest(*clientID, *clientSecret, *urlSTSToken)
		// Main app.
